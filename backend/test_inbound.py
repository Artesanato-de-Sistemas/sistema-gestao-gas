...
r2 = sb.table('inbound_items').insert({
...
total_p13 = sum(
    ...
    for x in sb.table('inbound_items').select('category, available_quantity').eq('category', 'GLP_13KG_CHEIO').execute().data
)
